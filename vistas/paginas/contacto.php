<section id='contacto' class="m-auto">
    <div class="textAnimation2">
        <p class="">Le invitamos a utilizar el siguiente formulario para enviarnos su mensaje o consulta. Nos pondremos en contacto con usted a la brevedad para brindarle la información y asistencia que necesite.</p>    
        ...
        <div class="d-flex flex-column">            
            <ul class="mediaicons d-flex nav justify-content-center flex-column mt-3">  
                <li class="nav-item"><a class="nav-link d-flex p-0 align-items-center"><i class="fas fa-map-marker-alt" aria-hidden="true"></i><p class="my-0 mx-2">Tte. Gral. J. D. Perón 1143</p></a></li>
                ...
                <li class="nav-item"><a class="nav-link d-flex p-0 align-items-center" href="tel:+5491143826817"><i class="fas fa-phone-alt" aria-hidden="true"></i><p class="my-0 mx-2">Teléfono/Fax: 011-4382-6817</p></a></li>
            </ul>   
        </div>
        <p class="small">Nuestro horario de atención directa es de lunes a viernes de 14.00 a 18.00 hs.</p>
